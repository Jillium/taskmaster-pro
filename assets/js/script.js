...
// trash droppable area can be dropped onto 
$("#trash").droppable({
...
// event listener for paragraphs, to allow client to edit tasks 
...
$(".list-group").on("change", "input[type='text']", function() {
  ...
  auditTask($(taskSpan).closest(".list-grou-item"));
});
...
var auditTask = function(taskEl) {
  ...
  //applyl new class if task is near/over due date
